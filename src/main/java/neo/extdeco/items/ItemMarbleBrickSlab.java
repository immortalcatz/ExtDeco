...
public class ItemMarbleBrickSlab extends ItemBlock
{
    private final boolean field_150948_b;
    private final BlockSlab singleSlab;
    private final BlockSlab doubleSlab;
    private static final String __OBFID = "CL_00000071";
    public ItemMarbleBrickSlab(Block block)
    {
     super(block);
     this.singleSlab = (BlockSlab) BlocksExtDeco.marbleBrickSlabSingle; //Here you have to set your single slab
     this.doubleSlab = (BlockSlab) BlocksExtDeco.marbleBrickSlabDouble; //And here your double slab
