...
public class SlotFreezer extends Slot
{
    ...
    public SlotFreezer(EntityPlayer p_i1813_1_, IInventory p_i1813_2_, int p_i1813_3_, int p_i1813_4_, int p_i1813_5_)
    {
    ...
    protected void onCrafting(ItemStack p_75208_1_)
    {
        ...
        if (!this.thePlayer.worldObj.isRemote)
        {
            ...
            float f = RecipesFreezer.smelting().giveExperience(p_75208_1_);
            int j;
