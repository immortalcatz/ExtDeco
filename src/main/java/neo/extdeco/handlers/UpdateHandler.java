...
public class UpdateHandler {
    ...
    public void checkUpdateClient(PlayerLoggedInEvent event) {
		if (ExtDeco.isDebug) {
			event.player.addChatMessage(new ChatComponentText("\u00a72[Ext Deco]\u00a7r You are using ExtDeco-Experimental-" + ExtDeco.VERSION));
			event.player.addChatMessage(new ChatComponentText("\u00a72[Ext Deco]\u00a7r WARNING: Bugs can destroy your World!!"));
		} else {
