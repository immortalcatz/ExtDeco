...
import neo.extdeco.blocks.BlockFreezer;
...
public class TileEntityFreezer extends TileEntity implements ISidedInventory {
	...
	public void freezerName(String string){
		this.freezerName = string;
	}
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.freezerName : "tile.extdeco_freezer.name";
	}

	@Override
	public boolean hasCustomInventoryName() {
		return this.freezerName != null && this.freezerName.length() > 0;
	}
	...
	public void readFromNBT(NBTTagCompound tagCompound) {
		...
		if (tagCompound.hasKey("CustomName", 8)) {
			this.freezerName = tagCompound.getString("CustomName");
		}
	}
	...
	public void writeToNBT(NBTTagCompound tagCompound) {
		...
		if (this.hasCustomInventoryName()) {
			tagCompound.setString("CustomName", this.freezerName);
		}
	}
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			BlockFreezer.updateFreezerBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
	...
	private boolean canSmelt() {
		if (this.furnaceItemStacks[0] == null) {
			...
			ItemStack itemstack = RecipesFreezer.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
